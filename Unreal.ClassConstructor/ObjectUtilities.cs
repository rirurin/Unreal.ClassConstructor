...
{
    public class ObjectUtilities_DEPRECATED : ModuleBase<ClassConstructorContext>, IObjectUtilities
    {
        // Class to pass in calls from IObjectUtilities interface into utility functions in inter-mod communication.
        public ObjectUtilities_DEPRECATED(ClassConstructorContext context, Dictionary<string, ModuleBase<ClassConstructorContext>> modules) : base(context, modules) {}
