...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "Unreal.ClassConstructor/Unreal.ClassConstructor.csproj",
    $PackageName = "Unreal.ClassConstructor",
    ...
    $NuGetPackageId = "Unreal.ClassConstructor",
...
# Publish interface
$InterfaceProjectPath = "Unreal.ClassConstructor.Interfaces/Unreal.ClassConstructor.Interfaces.csproj"
